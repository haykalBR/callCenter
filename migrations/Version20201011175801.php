 ...
 */
final class Version20201011175801 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE profile DROP CONSTRAINT fk_8157aa0f67b3b43d');
        $this->addSql('DROP INDEX uniq_8157aa0f67b3b43d');
        $this->addSql('ALTER TABLE profile RENAME COLUMN users_id TO user_id');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE profile RENAME COLUMN user_id TO users_id');
